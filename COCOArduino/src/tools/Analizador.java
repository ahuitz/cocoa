    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Analizador$act_num)
		...
		RESULT = start_val;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 1: // clase ::= CLASE NOMCLASE PROPIEDADES 
            {
              Object RESULT =null;
		...
		int ncleft = ((java_cup.runtime.Symbol)CUP$Analizador$stack.elementAt(CUP$Analizador$top-1)).left;
		int ncright = ((java_cup.runtime.Symbol)CUP$Analizador$stack.elementAt(CUP$Analizador$top-1)).right;
		token nc = (token)((java_cup.runtime.Symbol) CUP$Analizador$stack.elementAt(CUP$Analizador$top-1)).value;
		...
		token p = (token)((java_cup.runtime.Symbol) CUP$Analizador$stack.peek()).value;
            ...
            System.out.println(p.getCadena());
              ...
              CUP$Analizador$result = parser.getSymbolFactory().newSymbol("clase",0, ((java_cup.runtime.Symbol)CUP$Analizador$stack.elementAt(CUP$Analizador$top-2)), ((java_cup.runtime.Symbol)CUP$Analizador$stack.peek()), RESULT);
            }
          return CUP$Analizador$result;
